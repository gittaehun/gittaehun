...
public class PeopleTalk2 extends JDialog implements ActionListener{
	...
	public PeopleTalk2(FriendList fl){
		this.fl=fl;
		//initDisplay_PeopleTalk2();
		//FriendListThread flt = new FriendListThread(this);
	}
	
	public void initDisplay_PeopleTalk2(String roomTitle, String nickName){
